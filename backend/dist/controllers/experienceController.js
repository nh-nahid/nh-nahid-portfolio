...
function formatPeriodDate(dateVal) {
    if (!dateVal)
        return "";
...
function makePeriod(startDate, endDate, currentlyWorking) {
...
export const createExperience = async (req, res, next) => {
    try {
        const { company, role, employmentType, location, startDate, endDate, currentlyWorking, points, technologies, order, } = req.body;
        if (!company || !role) {
